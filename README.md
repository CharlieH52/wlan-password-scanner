...
> [!CAUTION] Únicamente será útil mientras que la interfaz **WMIC** siga en tu versión de **Windows**, que a partir de la versión ***24H2 de Windows 11*** estará siendo *deshabilitada* de todas las instalaciones de **Windows**, por lo que esta *"brecha"* para obtener las contraseñas **WLAN** desaparecerá.
...
> [!NOTE] Para **PostgreSQL** es necesario que primero crees una **función** que llevara la lógica de actualización y después tendrás que crear el **trigger** *vinculandolo* a la función.